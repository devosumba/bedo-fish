...
export default function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className="sticky top-8 w-full flex justify-center pt-0 pb-2 px-4 z-[1000]"
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3 pr-2">
          ...
          {/* TikTok */}
          <a href="https://www.tiktok.com/@bedo_fish_ke" target="_blank" rel="noopener noreferrer" aria-label="TikTok"
          ...
          {/* Instagram */}
          <a href="https://www.instagram.com/bedo_fish?igsh=cnlpeXhvZzA2Z2Yz" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
            className="text-[#014aad] hover:text-[#0145a3] transition-colors duration-200 focus:outline-none">
          ...
          {/* Phone */}
          <a href="tel:+254722144319" target="_self" aria-label="Call us"
            className="text-[#014aad] hover:text-[#0145a3] transition-colors duration-200 focus:outline-none">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          ...
          {mobileOpen && (
            ...
            >
              ...
              <div className="flex items-center gap-5 px-5 py-4 border-t border-gray-100">
                <a href="https://www.tiktok.com/@bedo_fish_ke" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-[#014aad] hover:text-[#0145a3] transition-colors">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                    <path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-2.88 2.5 2.89 2.89 0 0 1-2.89-2.89 2.89 2.89 0 0 1 2.89-2.89c.28 0 .54.04.79.1V9.01a6.27 6.27 0 0 0-.79-.05 6.34 6.34 0 0 0-6.34 6.34 6.34 6.34 0 0 0 6.34 6.34 6.34 6.34 0 0 0 6.33-6.34V8.69a8.18 8.18 0 0 0 4.78 1.52V6.76a4.85 4.85 0 0 1-1.01-.07z"/>
                  </svg>
                </a>
                <a href="https://www.instagram.com/bedo_fish?igsh=cnlpeXhvZzA2Z2Yz" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-[#014aad] hover:text-[#0145a3] transition-colors">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                    <rect x="2" y="2" width="20" height="20" rx="5" ry="5"/>
                    <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/>
                    <line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/>
                ...
                <a href="tel:+254722144319" target="_self" aria-label="Call us" className="text-[#014aad] hover:text-[#0145a3] transition-colors">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                    <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.59 3.38a2 2 0 0 1 2-2.18h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/>
                  </svg>
                </a>
