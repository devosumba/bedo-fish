...
export default function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className="relative w-full flex justify-center pt-0 pb-2 px-4 z-[1000] mt-6 md:mt-14"
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3 pr-2">
          ...
          {/* Call To Order */}
          <a
            href="tel:+254722144319"
            className="flex items-center gap-1.5 bg-[#014aad] text-white font-bold uppercase px-4 py-2 rounded-full hover:[filter:brightness(0.85)] transition-all duration-150 focus:outline-none whitespace-nowrap"
            style={{ fontSize: '12px' }}
          >
