...
const ExperienceSection = () => {
  ...
  return (
    ...
    <section
      id="our-story"
      ref={sectionRef}
      className="relative z-[2] bg-white w-full pt-10 md:pt-14 pb-0 -mt-8"
    >

      {/* ── Paragraph — font matches Our Offerings heading (text-4xl md:text-5xl font-extrabold) */}
      <div className="max-w-5xl mx-auto px-4 md:px-8 mb-0 mt-[60px] md:mt-[72px]">
        <p
      ...
      <div ref={imageContainerRef} className="h-[80vh] md:h-[300vh]" style={{ marginTop: '-70px' }}>
