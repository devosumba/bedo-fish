...
const TEAM_MEMBERS = [
  ...
  { name: 'Jim Kiche',     title: 'Head of Operations',      image: '/images/team/jim-kiche.jpeg',  imageStyle: { objectPosition: 'center top', transform: 'scale(1.2) translateY(-8%)' } },
  { name: 'Violet',        title: 'Production Manager',      image: '/images/team/violet.jpeg',     imageStyle: { objectPosition: 'center center' } },
];
